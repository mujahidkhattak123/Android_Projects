package mechanic.mechanic_app_finder.fyp.mechanic_app;
    ...
    public class Hospital_map_Acvt extends FragmentActivity implements
            OnMapReadyCallback,
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_hospital_map__acvt);
        ...
        public void onMapReady(GoogleMap googleMap) {
            ...
            database = FirebaseDatabase.getInstance().getReference("Hospital Details");
                        ...
                        public boolean onMarkerClick(@NonNull Marker marker) {
                            for(int j = 0; j<idd.length;j++){
                                if(marker.getTitle().equals(idd[j])){
                                    Intent intent = new Intent(Hospital_map_Acvt.this, Hospital_Detail_Actv.class);
