...
public class Electrcian_Map extends FragmentActivity implements
        OnMapReadyCallback,
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electrcian__map);
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        database = FirebaseDatabase.getInstance().getReference("Electrician Details");
                    ...
                    public boolean onMarkerClick(@NonNull Marker marker) {
                        for(int j = 0; j<idd.length;j++){
                            if(marker.getTitle().equals(idd[j])){
                                Intent intent = new Intent(Electrcian_Map.this,Electrician_Details.class);
