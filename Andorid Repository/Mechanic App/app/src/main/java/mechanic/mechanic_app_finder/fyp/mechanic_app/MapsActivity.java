...
//
    ...
    @Override
    public void onConnected(@androidx.annotation.Nullable android.os.Bundle bundle) {
...
//       LocationServices.FusedLocationApi.requestLocationUpdates(mGoogleApiClient,mLocationRequest,this);
 ...
 public void onLocationChanged(Location location) {
        ...
        /*FirebaseDatabase.getInstance().getReference("Hostel Location")
                .setValue(nu).addOnCompleteListener(new OnCompleteListener<Void>() {
            @Override
            public void onComplete(@NonNull Task<Void> task) {
                ...
                if (task.isSuccessful()){
                    ...
                    Toast.makeText(MapsActivity.this, "Location Not Saved", Toast.LENGTH_LONG).show();
