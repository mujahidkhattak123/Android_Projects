...
public class Electrician_Actv extends AppCompatActivity {
    ...
    String gender = "";
    StorageReference storageReference = FirebaseStorage.getInstance().getReference("Electrician Details");
    ...
    protected void onCreate(android.os.Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_electrician__actv);
        ...
        send.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                ...
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(Electrician_Actv.this, "Upload is in Progress", Toast.LENGTH_SHORT).show();
            ...
            fileReference.putFile(mUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@androidx.annotation.NonNull Task<Uri> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        Toast.makeText(Electrician_Actv.this,"Uploaded",Toast.LENGTH_SHORT).show();
                        finish();

                    } else {
                        Toast.makeText(Electrician_Actv.this, "upload failed: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
