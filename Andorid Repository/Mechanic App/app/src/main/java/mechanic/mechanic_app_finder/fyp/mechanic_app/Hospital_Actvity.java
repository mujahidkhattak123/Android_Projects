...
import mechanic.mechanic_app_finder.fyp.R;
    ...
    public class Hospital_Actvity extends AppCompatActivity {
        ...
        String gender = "";
        StorageReference storageReference = FirebaseStorage.getInstance().getReference("Hospital Details");
        ...
        protected void onCreate(android.os.Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_hospital__actvity);
            ...
            send.setOnClickListener(new android.view.View.OnClickListener() {
                ...
                public void onClick(android.view.View v) {
                    ...
                    if (mUploadTask != null && mUploadTask.isInProgress()) {
                        Toast.makeText(Hospital_Actvity.this, "Upload is in Progress", Toast.LENGTH_SHORT).show();
                ...
                fileReference.putFile(mUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                    ...
                    public void onComplete(@androidx.annotation.NonNull Task<Uri> task) {
                        ...
                        if (task.isSuccessful()) {
                            ...
                            Toast.makeText(Hospital_Actvity.this,"Uploaded",Toast.LENGTH_SHORT).show();
                            finish();

                        } else {
                            Toast.makeText(Hospital_Actvity.this, "upload failed: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                        }
                    }
                });
            }
