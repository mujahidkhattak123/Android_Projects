...
package mechanic.mechanic_app_finder.fyp.mechanic_app;
    ...
    public class Wheel_Alignment_Map extends FragmentActivity implements
            OnMapReadyCallback,
        ...
        protected void onCreate(Bundle savedInstanceState) {
            ...
            setContentView(R.layout.activity_wheel__alignment__map);
        ...
        public void onMapReady(GoogleMap googleMap) {
            ...
            database = FirebaseDatabase.getInstance().getReference("Wheel_alignment Details");
                        ...
                        public boolean onMarkerClick(@NonNull Marker marker) {
                            for(int j = 0; j<idd.length;j++){
                                if(marker.getTitle().equals(idd[j])){
                                    Intent intent = new Intent(Wheel_Alignment_Map.this, Wheel_alignment_Details.class);
