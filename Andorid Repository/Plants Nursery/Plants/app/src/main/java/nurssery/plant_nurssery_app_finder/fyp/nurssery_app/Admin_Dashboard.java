...
public class Admin_Dashboard extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    String gender = "";
    StorageReference storageReference = FirebaseStorage.getInstance().getReference("Mechanic Details");
        ...
        send.setOnClickListener(new android.view.View.OnClickListener() {
            ...
            public void onClick(android.view.View v) {
                ...
                if (mUploadTask != null && mUploadTask.isInProgress()) {
                    Toast.makeText(Admin_Dashboard.this, "Upload is in Progress", Toast.LENGTH_SHORT).show();
            ...
            fileReference.putFile(mUri).continueWithTask(new Continuation<UploadTask.TaskSnapshot, Task<Uri>>() {
                ...
                public void onComplete(@androidx.annotation.NonNull Task<Uri> task) {
                    ...
                    if (task.isSuccessful()) {
                        ...
                        databaseReference= FirebaseDatabase.getInstance().getReference().child("Mechanic Details");
                        ...
                        Toast.makeText(Admin_Dashboard.this,"Uploaded",Toast.LENGTH_SHORT).show();
                        finish();

                    } else {
                        Toast.makeText(Admin_Dashboard.this, "upload failed: " + task.getException().getMessage(), Toast.LENGTH_SHORT).show();
                    }
                }
            });
        }
