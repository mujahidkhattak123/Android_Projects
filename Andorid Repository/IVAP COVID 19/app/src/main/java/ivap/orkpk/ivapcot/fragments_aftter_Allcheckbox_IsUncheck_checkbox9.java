 ...
 * Use the {@link fragments_aftter_Allcheckbox_IsUncheck_checkbox9#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fragments_aftter_Allcheckbox_IsUncheck_checkbox9 extends Fragment {

    Button btnprevious, btnnext, btnyes, btnno;
    TextView txt_yes, txt_select;
    String contact_data,checkagree_data,data_yes1,data_yes1_after_check,main_raio_data,main_gender_radio_btn
            ,str_maincheck_store,data_no1_after_check,str_action_main1;
    ...
    public static fragments_aftter_Allcheckbox_IsUncheck_checkbox9 newInstance(String param1, String param2) {
        fragments_aftter_Allcheckbox_IsUncheck_checkbox9 fragment = new fragments_aftter_Allcheckbox_IsUncheck_checkbox9();
    ...
    public fragments_aftter_Allcheckbox_IsUncheck_checkbox9() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragments_aftter__allcheckbox__is_uncheck_checkbox9, container, false);
        ...
        data_yes1_after_check=btnyes.getText().toString();
        data_no1_after_check=btnno.getText().toString();
        ...
        btnyes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getActivity(), data_yes1_after_check, Toast.LENGTH_SHORT).show();

                str_action_main1=data_yes1_after_check;
                str_action_main1="Y";
                btnnext.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onClick(View view) {
                        ...
                        fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_2
                                page_9_2=new fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_2();
                        ...
                        Toast.makeText(getActivity(), checkagree_data+" \n "+"\n"+contact_data+" \n "
                                ...
                                +str_maincheck_store+"  "+"  "+"\n"+str_country+"\n"
                                +str_provice+"\n"+str_city+"\n"+str_district
                                +"\n"+str_spinner_age  +str_action_main1, Toast.LENGTH_SHORT).show();
        ...
        btnno.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                str_action_main1=data_no1_after_check;
                str_action_main1="N";
                Toast.makeText(getActivity(), data_no1_after_check, Toast.LENGTH_SHORT).show();
                btnnext.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {
                        Bundle bundle=new Bundle();
                        ...
                        bundle.putString("str_city",str_city);
                        bundle.putString("str_spinner_age",str_spinner_age);
                        bundle.putString("data_no1_after_check",data_no1_after_check);
                        bundle.putString("str_action_main1",str_action_main1);


                        fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_2      page_9_2=new fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_2();
                        page_9_2.setArguments(bundle);
                        getFragmentManager().beginTransaction().replace(R.id.datacontainer,page_9_2).commit();
                        Toast.makeText(getActivity(), checkagree_data+" \n "+"\n"+contact_data+" \n "
                                + data_yes1 +"\n"+main_raio_data+"\n"+main_gender_radio_btn+"\n"
                                +str_maincheck_store+"  "+"  "+"\n"+str_country+"\n"
                                +str_provice+"\n"+str_city+"\n"+str_district
                                +"\n"+str_spinner_age  +data_no1_after_check, Toast.LENGTH_SHORT).show();
