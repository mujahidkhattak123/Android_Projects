 ...
 * Use the {@link fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_4#newInstance} factory method to
 * create an instance of this fragment.
 */
public class fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_4 extends Fragment {
    ...
    String contact_data,checkagree_data,data_yes1,main_raio_data,main_gender_radio_btn
            ,str_maincheck_store,data_yes1_after_check,data_yes2_after_check,data_yes3_after_check,data_yes4_after_check
    ,data_no1_after_check,data_no2_after_check,data_no3_after_check,data_no4_after_check,
            str_action_main1,str_action_main2,str_action_main3,str_action_main4;
    ...
    public static fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_4 newInstance(String param1, String param2) {
        fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_4 fragment = new fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_4();
    ...
    public fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_4() {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        View view = inflater.inflate(R.layout.fragment_fragments_aftter__allcheckbox__is_uncheck_checkbox9_page_4, container, false);
        ...
        data_yes4_after_check=btnyes.getText().toString();
        data_no4_after_check=btnno.getText().toString();
        ...
        btnyes.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                Toast.makeText(getActivity(), data_yes4_after_check, Toast.LENGTH_SHORT).show();
                btnnext.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {

                        str_action_main4=data_yes4_after_check;
                        str_action_main4="Y";
                        ...
                        fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_5 page_9_5=new fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_5();
                        page_9_5.setArguments(bundle);
                        getFragmentManager().beginTransaction().replace(R.id.datacontainer,page_9_5).commit();
                        Toast.makeText(getActivity(), checkagree_data+" \n "+"\n"+contact_data+" \n "
                                + data_yes1 +"\n"+main_raio_data+"\n"+main_gender_radio_btn+"\n"
                                +str_maincheck_store+"  "+checkagree_data+"  "+"\n"+str_country+"\n"
                                +str_provice+"\n"+str_city+"\n"+str_district
                                +"\n"+str_spinner_age+str_action_main1+str_action_main2+str_action_main3+str_action_main4 , Toast.LENGTH_SHORT).show();
        ...
        btnno.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View view) {
                Toast.makeText(getActivity(), data_no4_after_check, Toast.LENGTH_SHORT).show();
                btnnext.setVisibility(View.VISIBLE);
                btnnext.setOnClickListener(new View.OnClickListener() {
                    @Override
                    public void onClick(View view) {

                        str_action_main4=data_no4_after_check;
                        str_action_main4="N";
                        Bundle bundle=new Bundle();
                        bundle.putString("key_Yes1",data_yes1);
                        bundle.putString("key_contact",contact_data);
                        ...
                        Toast.makeText(getActivity(), checkagree_data+" \n "+"\n"+contact_data+" \n "
                                ...
                                +str_maincheck_store+"  "+checkagree_data+"  "+"\n"+str_country+"\n"
                                +str_provice+"\n"+str_city+"\n"+str_district
                                +"\n"+str_spinner_age+str_spinner_age+str_action_main1+str_action_main2+str_action_main3+str_action_main4 , Toast.LENGTH_SHORT).show();
        ...
        btnprevious.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_3      page_9_2=new fragments_aftter_Allcheckbox_IsUncheck_checkbox9_page_3();
